...
func TestGBRoundTrip(t *testing.T) {
	for _, test := range []struct {
		...
		{
			Name: "GBCanonicalUnmarshal",
			SDP:  GBCanonicalUnmarshalSDP,
		},
		{
			Name: "GBCanonicalUnmarshal2",
			SDP:  GBCanonicalUnmarshalSDP2,
		},
	} {
		test := test
